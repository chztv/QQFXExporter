...
(function(TLE) {
  ...
  function init() {
  	...
  	$("label.check_all_text").after('<span style="height:35px;line-height:35px;">RPC-Path:<input type="text" id="TLE_aria2_jsonrpc" style="width: 200px" value="'+TLE.getConfig("TLE_aria2_jsonrpc")+'"/></span>');
    //css
    $("head").append('<style>'
