...
(function(TLE) {
  ...
  function init() {
  	...
  	$("label.check_all_text").after('<span style="height:35px;line-height:35px;">RPC-Path:<input type="text" id="QQ_aria2_jsonrpc" style="width: 200px" value="'+jsonrpc_path+'"/><a href="#" class="btn_nol" id="setting_button_sure" onclick="set_notice_submit2(0);return false;" title="保存设置">保存设置</a></span>');
    //css
    $("head").append('<style>'
