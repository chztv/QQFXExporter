...
(function(TLE) {
  ...
  function init() {
  	...
  	$("label.check_all_text").after('<span style="display:block;height:35px;line-height:35px;">RPC-Path:<input type="text" id="TLE_aria2_jsonrpc" style="width: 200px" value="http://chztv.3322.org:6800"/></span>');
    //css
    $("head").append('<style>'
