...
(function(TLE) {
  ...
  function init() {
  	...
  	$("#jisu_box").html('<a href="javascript:;" class="download_btn" id="jisu_btn_chz" title="Aria2下载"><em>Aria下载</em></a>
                            <span class="box_info">
                                <i><b></b></i>
                                <span class="download_info">平均下载速度统计</span>
                                <span class="download_speed"><span>3000</span>KB/s</span>
                            </span>');
    //css
    $("head").append('<style>'
